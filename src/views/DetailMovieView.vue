      ...
      <div class="md:flex px-4 leading-none max-w-4xl">
        ...
        <div class="flex-col text-gray-300">
          ...
          <p class="flex text-md px-4 my-2">
            ...
            <span class="sm:block sm:text-center md:text-left font-semibold"> <span v-if="data.price">Rp.{{data.price}}</span><span v-else>Tiket Belum Dijual.</span></span>           
          </p>
          <p class="flex text-md px-4 my-2">
...
export default{
  ...
  async mounted (){
    ...
    if (res.success){
      this.data = res.data
      this.data.price = this.data.price ? this.data.price.toLocaleString('id-ID') : null
